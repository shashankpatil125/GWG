    ...
    <div className='w-screen h-screen bg-no-repeat bg-cover' style={{ backgroundImage: `url(${dark})` }}>
      <div class="flex h-screen justify-center items-center">
        <div class="text-center ">
          <h1 class="text-3xl font-font-mast text-6xl text-white mb-8">Sign in</h1>
          <p class="text-xl text-white mb-3 text-2xl">Sign in and get started</p>
          <div className='w-80'>
            ...
            <button className=" text-white w-full mt-4 rounded-lg h-10 text-xl text-center bg-green-600 mb-4">Login</button>
          </div>
        </div>
      </div>
    </div>
...
function lightground() {
  return (
    <div className='w-screen h-screen bg-no-repeat bg-cover' style={{ backgroundImage: `url(${light})` }}>
      <div class="flex h-screen justify-center items-center">
        <div class="text-center ">
          <h1 class="text-3xl font-font-mast text-6xl text-black mb-8">Sign in</h1>
          <p class="text-xl text-white mb-3 text-2xl text-black">Sign in and get started</p>
          <div className='w-80'>
            <input type="text" placeholder='Login' className="w-full rounded-lg h-10 text-xl pl-6 mb-4 text-white bg-sky-900" ></input>
            <br />
            <input type="Password" placeholder='Password' className="w-full rounded-lg h-10 text-xl pl-6 mb-4 text-white bg-sky-900"></input>
            ...
            <button className="w-full mt-4 rounded-lg h-10 text-xl text-center bg-green-600 mb-4">Login</button>
          </div>
        </div>
      </div>
    </div>
